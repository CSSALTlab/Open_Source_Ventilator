//Version 135a - version 135 with VT measured on exp limb
/*
...
#ifdef USHAPEEXPLIMB
//
/*if (RawDigitalPressure > 145.90) {          // For 65 lpm and below //ventCode135
    instantFlowValue = 0.398390192 * RawDigitalPressure + 7.295880128;
  } else if (RawDigitalPressure > 132.37) {   // For 60 lpm and below
    instantFlowValue = 0.398390192 * RawDigitalPressure + 7.295880128;
  } else if (RawDigitalPressure > 94.52) {   // For 50 lpm and below
    instantFlowValue = 0.26586921 * RawDigitalPressure + 24.83772077;
  } else if (RawDigitalPressure > 59.59) {   // For 40 lpm and below
    instantFlowValue = 0.28445059 * RawDigitalPressure + 23.08149943;
  } else if (RawDigitalPressure > 31.96) {   // For 30 lpm and below
    instantFlowValue = 0.368516869 * RawDigitalPressure + 18.07162715;
  } else if (RawDigitalPressure > 13.71) {   // For 20 lpm and below
    instantFlowValue = 0.560112653 * RawDigitalPressure + 11.94835048;
  } else if (RawDigitalPressure > 3.10) {    // For 10 lpm and below
    instantFlowValue = 0.910966588 * RawDigitalPressure + 7.137733651;
  } else if (RawDigitalPressure > 0.31) {    // For 5 lpm and below
    instantFlowValue = 1.851101709 * RawDigitalPressure + 4.222986479;
  } else {
    instantFlowValue = 0;
  }           // unit is liters/minute
*/
...
// if (pressure > 145.90) {          // For 65 lpm and below
//    instantFlowValue = 0.398390192 * RawDigitalPressure + 7.295880128;
//  } else if (pressure > 132.37) {   // For 60 lpm and below
//    instantFlowValue = 0.26586921 * RawDigitalPressure + 24.83772077;
//  } else if (pressure > 94.52) {   // For 50 lpm and below
//    instantFlowValue = 0.28445059 * RawDigitalPressure + 23.08149943;
//  } else if (pressure > 59.59) {   // For 40 lpm and below
//    instantFlowValue = 0.368516869 * RawDigitalPressure + 18.07162715;
//  } else if (pressure > 31.96) {   // For 30 lpm and below
//    instantFlowValue = 0.560112653 * RawDigitalPressure + 11.94835048;
//  } else if (pressure > 13.71) {   // For 20 lpm and below
//    instantFlowValue = 0.910966588 * RawDigitalPressure + 7.137733651;
//  } else if (pressure > 3.10) {    // For 10 lpm and below
//    instantFlowValue = 1.851101709 * RawDigitalPressure + 4.222986479;
//  } else if (pressure > 0.31) {    // For 5 lpm and below
//    instantFlowValue = 16.15451089 * RawDigitalPressure - 0.222479222;
//  } else {
//    instantFlowValue = 0;
//  }           // unit is liters/minute
...
/*------------5F-------INITALIZE STATE VARIABLES  GLG0531  -------------------------------*/
  ...
  if (current_phase == cut_off) { //IZ 6/17/2020 prev: current_phase == cut_off //2/8/21
...
// GLG0531  Steve's simplifiation here due to new definition of cut_off is correct
  ...
  if ( current_phase >= cut_off) { // Note that if we have jammed an inspiratio to start, this will be avoided   //IZ 6/17/2020 prev: current_phase >= cut_off
...
if (do_measure_plat == 1 && current_phase == cut_off){
  ...
  if (current_phase >= cut_off+1){ //2/8/21
    ...
    //exmLPerCycle = (int) exLitersPerCycle; //2/8/21
    //exLitersPerCycle=0; //2/8/21
...
/*-------9D--------------CONCLUDE AND MOVE TO NEXT CYCLE------------------------------------------------------*/
 ...
 // So, for example, if MAX_PHaSES is 20, we will execute respiratory cycle for phases 0 through 19
  ...
  exmLPerCycle = (int) exLitersPerCycle; // note exmLPerCycle= INT //IZ 6/19/2020 //2/8/21
   ...
   if (exmLPerCycle < 0) exmLPerCycle = 0; // dont allow negative numbers  TD comment out on 6_19_20 //2/8/21
...
#ifdef  FLOWMEASURE2
Serial.print(F("T.Wid, I.Flow, exLPC, RawDP: "));
Serial.print(time_width);
Serial.print(F(" "));
Serial.print(instantFlowValue);
Serial.print(F(" "));
Serial.println(exLitersPerCycle);
//Serial.print(F(" ")); //added 6_19
//Serial.println(diffpressure); //added 6_19
#endif
